...
public class ChatController {
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = handler.obtainMessage(SyncDataActivity.MESSAGE_DEVICE_OBJECT);
        Bundle bundle = new Bundle();
        bundle.putParcelable(SyncDataActivity.DEVICE_OBJECT, device);
        msg.setData(bundle);
    ...
    private class ReadWriteThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    handler.obtainMessage(SyncDataActivity.MESSAGE_READ, bytes, -1,
                            buffer).sendToTarget();
                } catch (IOException e) {
                    connectionLost();
                    // Start the service over to restart listening mode
        ...
        public void write(byte[] buffer) {
            try {
                ...
                handler.obtainMessage(SyncDataActivity.MESSAGE_WRITE, -1, -1,
                        buffer).sendToTarget();
            } catch (IOException e) {
            }
        }
